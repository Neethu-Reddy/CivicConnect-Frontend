...
class AdminManager {
    ...
    loadAllReports() {
        try {
            this.allReports = JSON.parse(localStorage.getItem('civicconnect_reports') || '[]');
    ...
    updateIssueStatus(reportId, newStatus) {
        try {
            const reports = JSON.parse(localStorage.getItem('civicconnect_reports') || '[]');
            ...
            if (reportIndex !== -1) {
                ...
                localStorage.setItem('civicconnect_reports', JSON.stringify(reports));
    ...
    deleteIssue(reportId) {
        if (confirm('Are you sure you want to delete this issue? This action cannot be undone.')) {
            try {
                ...
                localStorage.setItem('civicconnect_reports', JSON.stringify(filteredReports));
