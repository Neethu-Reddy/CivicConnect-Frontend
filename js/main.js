...
document.addEventListener('DOMContentLoaded', function() {
    console.log('CivicConnect initializing...');
...
function loadThemePreference() {
    const savedTheme = localStorage.getItem('civicconnect-theme') || 'light';
...
function loadNotificationPreferences() {
    const pushEnabled = localStorage.getItem('civicconnect-push') !== 'false';
    const emailEnabled = localStorage.getItem('civicconnect-email') !== 'false';
