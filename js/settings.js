class SettingsManager {
    ...
    setupThemeSwitcher() {
        ...
        const currentTheme = localStorage.getItem('civicconnect-theme') || 'light';
    ...
    setupNotificationSettings() {
        ...
        if (pushNotifications) {
            pushNotifications.addEventListener('change', (e) => {
                this.saveNotificationSetting('civicconnect-push', e.target.checked);
            });
        }

        if (emailUpdates) {
            emailUpdates.addEventListener('change', (e) => {
                this.saveNotificationSetting('civicconnect-email', e.target.checked);
            });
        }
    }
